...
const Resume = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = 'data:application/pdf;base64,JVBERi0xLjQKJcOkw7zDtsO...'; // Placeholder base64
            ...
            {selfLearning.map((learning, index) => (
              ...
              >
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Key Projects:</p>
